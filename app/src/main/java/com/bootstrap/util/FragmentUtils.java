...
import com.bootstrap.ui.fragment.BaseFragment;
...
public class FragmentUtils {
    ...
    public static void replaceFragment(final FragmentManager fragmentManager, final BaseFragment fragment, final String tag, final int containerToReplace, final boolean addToBackStack, final View sharedElement, final String sharedElementId) {
        FragmentTransaction fragmentTransaction = ensureTransaction(fragmentManager);
        fragmentTransaction.replace(containerToReplace, fragment, tag).addSharedElement(sharedElement, sharedElementId);
        commitTransactions(fragmentTransaction, addToBackStack);
    }
